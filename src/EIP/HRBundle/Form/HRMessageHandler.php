...
/**
	\class HRMessageHandler
	\brief Manages the create and edit action for the HRMessage entities
*/
class HRMessageHandler {
  ...
  */
  ...
  /**
	\fn onSuccess(HRMessage)
	\brief Create or edit the entity
  */
  public function onSuccess(HRMessage $message) {
        if ($this->create) {
