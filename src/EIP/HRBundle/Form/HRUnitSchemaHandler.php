...
use EIP\HRBundle\Entity\HRUnitSchema;

/**
	\class HRunitSchemaHandler
	\brief Manages the create and edit action for the HRUnitSchema entities
*/
class HRunitSchemaHandler {
  ...
  */
  ...
  /**
	\fn onSuccess(HRUnitSchema)
	\brief Create or edit the entity
  */
  public function onSuccess(HRUnitSchema $schema) {
    if ($this->create) {
